...
import com.weixingwang.threepomelo.adapter.MySecondFragmentRecyAdapter;
 ...
 */
public class SecondShopFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.second_shop_fragment_layout;
    }

    @Override
    protected void initView(View v) {
        PullToRefreshLayout swrf = (PullToRefreshLayout) v.findViewById(R.id.my_second_fragment_swrf);
        recycl = (RecyclerView) v.findViewById(R.id.my_second_fragment_recyle);
        refrush(swrf);
    }
    ...
    private void getData() {
        ...
        map.put("page", page+"");
        OkHttpUtils.get(UrlUtils.TEAM_ER_SHOP_Url, ShearPreferenceUtils.getToken(getActivity()),
    ...
    private void setShiAdapter(List<MyTeamVIPBean.MyTeamListEntity> bean) {
        ...
        if(list!=null&&list.size()>0){
            recycl.setAdapter(new MySecondFragmentRecyAdapter(getActivity(),recycl,list,
                    R.layout.fragment_my_second_item,1));
        }
