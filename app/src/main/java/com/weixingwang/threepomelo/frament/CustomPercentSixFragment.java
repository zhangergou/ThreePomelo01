...
public class CustomPercentSixFragment extends BaseFragment{
    ...
    protected void initView(View v) {
        swrf = (SwipeRefreshLayout) v.findViewById(R.id.custom_fragment_percent_six_swrf);
        scrollView = (MyScrollView) v.findViewById(R.id.custom_fragment_percent_six_scro);
