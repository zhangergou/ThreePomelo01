 ...
 */
public class ShopPercentTwelveFragmentRecyAdapter extends BaseRecyleAdapter {

    private List<?> reList;

    public ShopPercentTwelveFragmentRecyAdapter(Context context, RecyclerView recl, List<?> reList, int layoutId, int clum) {
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(View itemView) {
            super(itemView);
            tvName = (TextView) itemView.findViewById(R.id.tv_percent_twelve_shop);
            tvJili = (TextView) itemView.findViewById(R.id.tv_percent_twelve_shop_jili);
            tvTime = (TextView) itemView.findViewById(R.id.tv_percent_twelve_shop_time);
        }
    }
}
