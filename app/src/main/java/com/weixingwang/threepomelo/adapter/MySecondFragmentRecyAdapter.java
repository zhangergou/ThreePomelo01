 ...
 */
public class MySecondFragmentRecyAdapter extends BaseRecyleAdapter{
    private List<?> reList;

    public MySecondFragmentRecyAdapter(Context context, RecyclerView recl, List<?> reList, int layoutId, int clum) {
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(View itemView) {
            super(itemView);
            tvName = (TextView) itemView.findViewById(R.id.tv_my_second_shop_fragment_item_name);
            tvMoney = (TextView) itemView.findViewById(R.id.tv_my_second_shop_fragment_item_money);
            tvType = (TextView) itemView.findViewById(R.id.tv_my_second_shop_fragment_item_type);
            tvLince = (TextView) itemView.findViewById(R.id.tv_my_second_shop_fragment_item_lince);
