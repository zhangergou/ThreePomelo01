 ...
 */
public class ShopPercentTwentyFourFragmentRecyAdapter extends BaseRecyleAdapter {

    private List<?> reList;

    public ShopPercentTwentyFourFragmentRecyAdapter(Context context, RecyclerView recl, List<?> reList, int layoutId, int clum) {
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(View itemView) {
            super(itemView);
            tvName = (TextView) itemView.findViewById(R.id.tv_percent_twenty_four_shop);
            tvJili = (TextView) itemView.findViewById(R.id.tv_percent_twenty_four_shop_jili);
            tvTime = (TextView) itemView.findViewById(R.id.tv_percent_twenty_four_shop_time);
        }
    }
}
